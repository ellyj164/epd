...
<div class="container">
    <div class="row justify-center">
        <div class="col-10">
            <div class="card mt-4">
                <div class="card-body">
                    <h1 class="card-title">Your Privacy Choices</h1>
                    ...
                    <div class="page-content">
                        ...
                        <section>
                            <h2>Overview</h2>
                            <p>This page contains important information about our Your Privacy Choices. We are committed to transparency and providing clear information to our users.</p>
                        </section>
