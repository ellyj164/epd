...
class __TwigTemplate_a631ea3fb109507ab914d6437679d5dc extends Template
{
    private $source;
    private $macros = [];
...
yield _gettext("Export the data of all tables.");
  ...
  ";
    ...
    {
        return new Source("", "database/export/index.twig", "/home/duns1/public_html/phpmyadmin/templates/database/export/index.twig");
    }
}
