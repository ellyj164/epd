<?php
/**
 * FezaMarket Community Page
 * E-Commerce Platform
 */

require_once __DIR__ . '/includes/init.php';

$page_title = 'FezaMarket Community';
...
<div class="container">
    <div class="row justify-center">
        <div class="col-10">
            <div class="card mt-4">
                <div class="card-body">
                    <h1 class="card-title">FezaMarket Community</h1>
                    ...
                    <div class="page-content">
                        ...
                        <section>
                            <h2>Overview</h2>
                            <p>This page contains important information about our FezaMarket Community. We are committed to transparency and providing clear information to our users.</p>
                        </section>
